...
public class SSHclient {
	String res="";
	public String sendMoney(String ip,String walletAddress,String amount) throws JSONException {
...
JSONObject jsonString = new JSONObject()
	...
	.put("method", "send").put("receiver_wallet_address",walletAddress).put("amount", amount);
