...
import com.aws.connectinssh.GetTBalances;
import com.database.connection.GetChainMembersClass;

/**
 * Servlet implementation class GetTotalBalances
 */
@WebServlet("/GetTotalBalances")
public class GetTotalBalances extends HttpServlet {
...
HttpSession session =request.getSession();
		...
		GetTBalances bal =new GetTBalances();
		try {
			String balance=bal.getAccountSummary(ip);
